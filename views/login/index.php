...
<div class="d-flex justify-content-center align-items-center vh-50">
    <form class="col-lg-4 border border rounded p-3">
        <div class="row mb-3">
            <div class="col">
                <label for="usu_catalogo" class="form-label">Catalogo</label><br />
                <input type="number" class="form-control" id="usu-catalogo">
            </div>
        </div>
        <div class="row mb-3">
            <label for="usu_password" class="form-label">Contraseña</label><br />
